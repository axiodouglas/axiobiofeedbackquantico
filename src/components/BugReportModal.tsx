...
export default function BugReportModal({ open, onOpenChange }: BugReportModalProps) {
  ...
  const handleSubmit = async () => {
    if (!category || !description.trim() || !imageFile) {
      toast({ title: "Preencha todos os campos", description: "Categoria, descrição e print são obrigatórios.", variant: "destructive" });
      return;
    }
    if (!user) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            {!imagePreview ? (
              ...
              >
                ...
                <span className="text-xs font-medium">Anexar print do erro (obrigatório)</span>
              </button>
            ) : (
          ...
          <Button
            ...
            disabled={sending || !category || !description.trim() || !imageFile}
          >
